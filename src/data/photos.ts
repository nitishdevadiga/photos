...
export const photos: Photo[] = [
  ...
  {
    id: '26',
    src: img('26-dark-leaves.jpeg'),
    title: 'After the rain, a wall of green',
    caption: 'No subject, just patience.',
    moods: ['quiet', 'dark'],
    date: '2025-04',
    aspect: 'portrait',
  },
  {
    id: '27',
    src: img('27-red-petal.jpeg'),
    title: 'A petal that argued back',
    caption: 'One drop, one small fire.',
    moods: ['quiet', 'burning'],
    date: '2025-03',
    featured: true,
    aspect: 'portrait',
  ...
  {
    id: '28',
    src: img('28-jumping-spider.jpeg'),
    title: 'Eight eyes, no notes',
    caption: 'Met on a leaf at midday.',
    moods: ['quiet', 'wander'],
    date: '2025-04',
    aspect: 'portrait',
  },
  {
    id: '29',
    src: img('29-damselfly-field.jpeg'),
    title: 'Damselfly, paddy field',
    caption: 'Held by a single blade.',
    moods: ['quiet', 'wander'],
    date: '2025-05',
    featured: true,
    aspect: 'portrait',
  ...
  {
    id: '30',
    src: img('30-golden-droplet.jpeg'),
    title: 'Light, in a single drop',
    caption: 'A small sun, briefly held.',
    moods: ['burning', 'quiet'],
    date: '2025-02',
    aspect: 'portrait',
  },
